...
JsHelper: {"": "Object;jQuery,gmaps,elementId",
...
["map", "package:mapengine/gmap.dart", , R, {
GMap: {"": "Object;elementId,js,mapOptions,gmaps",
  GMap$1: function(elementId) {
    ...
    this.js = new B.JsHelper(J.$index$asx($.get$context(), "jQuery"), J.$index$asx(J.$index$asx($.get$context(), "google"), "maps"), this.elementId);
  },
  static: {
GMap$: function(elementId) {
  var t1 = new R.GMap(elementId, null, null, J.$index$asx(J.$index$asx($.get$context(), "google"), "maps"));
  t1.GMap$1(elementId);
  return t1;
}}
...
function dart_precompiled($collectedClasses) {
  ...
  function JsHelper(jQuery, gmaps, elementId) {
    this.jQuery = jQuery;
    this.gmaps = gmaps;
  ...
  function GMap(elementId, js, mapOptions, gmaps) {
    this.elementId = elementId;
    this.js = js;
